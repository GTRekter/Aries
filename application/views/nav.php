            ...
            <ul class="nav navbar-right top-nav">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    	<i class="flaticon-user65"></i> Bagalà <b class="caret"></b>
                    </a>
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="bg-blue">
                        ...
                        <ul id="products" class="collapse">
                            <li><a href="<?php echo site_url('back/products'); ?>">Lista Prodotti</a></li>
                            <li><a href="<?php echo site_url('back/n_product'); ?>">Inserisci Prodotto</a></li>
                        </ul>
                    </li>
                    <li class="bg-blue">
                        <a href="javascript:;" data-toggle="collapse" data-target="#category">
                        	<i class="flaticon-read1"></i>  Categorie </a>
                        <ul id="category" class="collapse">
                            <li><a href="<?php echo site_url('back/categories'); ?>">Lista Categorie</a></li>
                            <li><a href="<?php echo site_url('back/n_category'); ?>">Inserisci Categoria</a></li>
                        </ul>
                    </li>
                    <li class="bg-blue">
                        <a href="javascript:;" data-toggle="collapse" data-target="#articles">
                        	<i class="flaticon-newspaper11"></i>  Articoli 
                        </a>
                        <ul id="articles" class="collapse">
                            <li><a href="<?php echo site_url('back/articles'); ?>">Lista Articoli</a></li>
                            <li><a href="<?php echo site_url('back/n_article'); ?>">Inserisci Articolo</a></li>
                        </ul>
                    </li>
					...
					<li class="bg-yellow">
					    <a href="javascript:;" data-toggle="collapse" data-target="#newsletter">
					    	<i class="flaticon-speechballoon7"></i>  Newsletter 
					    </a>
					    <ul id="newsletter" class="collapse">
					        <li><a href="<?php echo site_url('back/costumers'); ?>">Lista Iscritti</a></li>
					        <li><a href="<?php echo site_url('back/n_newsletter'); ?>">Crea Newsletter</a></li>
					    </ul>
					</li>
					<li class="bg-red">
