						...
						<div class="box-body">
							<div class="form-group">
								...
								<select class="form-control" name="tableName">
							        <option value="PRD_Products">Prodotti</option>
							        <option value="BLG_Articles">Articoli</option>
							        <option value="GEN_Costumers">Clienti</option>
							        <option value="GEN_Photos">Fotografie</option>
