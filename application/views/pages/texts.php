							...
							<table class="table table-hover">
						        ...
						        <?php if($texts) : ?>
						        	<?php foreach ($texts as $text) : ?>
								    	<tr>
								    		<td href="<?php echo site_url('back/text/' . $text->idText); ?>"><?php echo ucfirst($text->textTitle_it); ?></td>
								    		<td href="<?php echo site_url('back/text/' . $text->idText); ?>"><?php echo ucfirst( substr($text->textDescription_it,0,100). '...'); ?></td>
